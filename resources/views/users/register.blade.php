<x-layout>
    ...
    >
        <header class="text-center">
            ...
            <p class="mb-4 text-black dark:text-white">Create an account to post gigs</p>
        </header>

        <form action="/users" method="POST">
            @csrf
            <div class="mb-6">
                <label for="name" class="inline-block text-black dark:text-white text-lg mb-2">
                    Name
                </label>
                <input
                    type="text"
            ...
            <div class="mb-6">
                <label
                    for="password"
                    class="inline-block text-black dark:text-white text-lg mb-2"
                >
                    Password
                </label>
                <input
            ...
            <div class="mb-6">
                <button
                    type="submit"
                    class="bg-laravel text-black dark:text-white rounded py-2 px-4 hover:bg-black"
                >
                    Sign Up
                </button>
            </div>
